...
//     version 1.11.2
//     from Assets/Externals/4K_Space_Skyboxes/Demo/Scripts/DemoActionList.inputactions
//
...
public partial class @DemoActionList: IInputActionCollection2, IDisposable
{
    ...
    ~@DemoActionList()
    {
        UnityEngine.Debug.Assert(!m_Demo.enabled, "This will cause a leak and performance issues, DemoActionList.Demo.Disable() has not been called.");
    }
